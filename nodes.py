...
class AVLatentSync:
    ...
    def inference(self, images, audio, seed, lips_expression=1.5, inference_steps=20):
        ...
        try:
            ...
            model_root = os.path.join(folder_paths.models_dir, "lipsync/latentsync")
            ...
            ckpt_path = os.path.join(model_root, "latentsync_unet.pt")
            whisper_ckpt_path = os.path.join(model_root, "whisper", "tiny.pt")
...
NODE_CLASS_MAPPINGS = {
    ...
    "AVVideoLengthAdjuster": AVVideoLengthAdjuster,
}

# Display Names for ComfyUI
NODE_DISPLAY_NAME_MAPPINGS = {
    "AVLatentSync": "AV LatentSync1.5 Node",
    "AVVideoLengthAdjuster": "AV Video Length Adjuster",
 }